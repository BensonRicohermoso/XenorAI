...
export default function Home() {
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-[#2A2A5B] to-[#121235] relative">
      ...
      {/* Footer */}
      <footer className="min-h-screen snap-start bg-[#1A1A45] py-20">
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            {/* Footer Title */}
            <div className="text-center mb-16">
              <h2 className="text-5xl font-bold text-white mb-4">Get In Touch</h2>
              <p className="text-xl text-white/80">Let's connect and collaborate</p>
            </div>
            ...
            <div className="border-t border-white/20 pt-8 text-center">
              <p className="text-white/60">© 2026 XenorAI. All rights reserved.</p>
            </div>
          </div>
        </div>
      </footer>
